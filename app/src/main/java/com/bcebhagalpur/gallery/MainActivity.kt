...
import com.bcebhagalpur.gallery.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.images.observe(this, androidx.lifecycle.Observer<List<MediaStoreImage>> { images ->
            galleryAdapter.submitList(images)
        })

        viewModel.permissionNeededForDelete.observe(this, androidx.lifecycle.Observer { intentSender ->
            intentSender?.let {
